...
if __name__ == '__main__':
    ...
    parser.add_argument("--gpu", dest='gpu', type=str, default='4',help='Set CUDA_VISIBLE_DEVICES environment variable, optional')
    # parser.add_argument("--output_dir", dest='output_dir', type=str,
    #                     default='feats/res152', help='directory to store features')
    parser.add_argument("--output_dir", dest='output_dir', type=str,default='/data/yss/dataset/AVE_Dataset/AVE/compress_0330/res152_test_256', help='directory to store features')
    parser.add_argument("--n_frame_steps", dest='n_frame_steps', type=int, default=80,help='how many frames to sampler per video')

    parser.add_argument("--video_path", dest='video_path', type=str,default='/data/yss/dataset/AVE_Dataset/AVE/compress_0330/frame_test_256', help='path to video dataset')
